...
LOGO="/usr/local/images/SRA-logo-square.jpg"
...
PROMPT_MESSAGE="Your Mac's FileVault encryption key needs to be escrowed by Iron Mountains IT.

Click the Next button below, then enter your Mac's password when prompted. Touch base with Jarin, if you have any questions."
...
Please contact the ServiceDesk for help with your Mac password."
...
FAIL_MESSAGE="Sorry, an error occurred while escrowing your FileVault key. Please contact the ServiceDesk for help."
